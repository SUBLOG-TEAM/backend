...
public class RegisterFixture {
    ...
    public static MemberRegisterForm 폼_객체_만들기(String uid, String name, String password, String passwordCheck) {
        return new MemberRegisterForm(uid, name, password, passwordCheck);
    }
